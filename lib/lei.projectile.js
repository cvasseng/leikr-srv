...
//Projectile object
var Projectile = function (origin, originator, direction, decay, speed, ondone) {
...
module.exports = {
	create: function (origin, originator, direction, decay, speed, ondone) {
		return new Projectile(origin, originator, direction, decay, speed, ondone);
	}
}
